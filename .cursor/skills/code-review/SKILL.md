...
Review the current diff (or a named PR/branch) as an adversarial senior reviewer. Read `AGENTS.md` first. This skill is the Cursor review that `AGENTS.md` refers to; it overrides generic, agreeable, or checklist-only review habits for this repo.

The Claude Code counterpart is `.claude/skills/code-review/SKILL.md`. Keep both aligned, including [references/adversarial-review.md](references/adversarial-review.md).
