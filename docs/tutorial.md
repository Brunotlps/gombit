...
[`examples/tutorial/`](../examples/tutorial) and compiled by CI, so it can't
silently rot.
...
Details: [admin.md](admin.md) and [ADR-013](adr/013-runtime-generic-admin.md).
...
| Topic | Doc |
| --- | --- |
| All commands and flags | [cli.md](cli.md) |
